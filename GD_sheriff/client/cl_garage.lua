...
RMenu.Add('garagesheriff', 'main', RageUI.CreateMenu("Garage", "Garage du LSPD"))
...
function spawnuniCar(car)
    ...
    local plaque = "LSSD"..math.random(1,9)
...
Citizen.CreateThread(function()
	...
	ped = CreatePed("PED_TYPE_CIVMALE", "s_m_y_sheriff_01", 373.41, -1616.85, 0.29, 235.52, false, true) -- voiture
...
Citizen.CreateThread(function()
	...
	ped = CreatePed("PED_TYPE_CIVMALE", "s_m_y_sheriff_01", 370.57, -1604.67, 35.95, 50.59, false, true) -- helico
	SetBlockingOfNonTemporaryEvents(ped, true)
	FreezeEntityPosition(ped, true)
end)
...
Citizen.CreateThread(function()
	...
	ped = CreatePed("PED_TYPE_CIVMALE", "s_m_y_sheriff_01", 366.05, -1608.19, 28.29, 308.21, false, true)
	SetBlockingOfNonTemporaryEvents(ped, true)
	FreezeEntityPosition(ped, true)
