...
RMenu.Add('sheriff', 'main', RageUI.CreateMenu("LSPD", "Intéraction"))
RMenu.Add('sheriff', 'inter', RageUI.CreateSubMenu(RMenu:Get('sheriff', 'main'), "LSPD", "Intéraction"))
RMenu.Add('sheriff', 'info', RageUI.CreateSubMenu(RMenu:Get('sheriff', 'main'), "LSPD", "Intéraction"))
RMenu.Add('sheriff', 'doc', RageUI.CreateSubMenu(RMenu:Get('sheriff', 'main'), "LSPD", "Intéraction"))
RMenu.Add('sheriff', 'renfort', RageUI.CreateSubMenu(RMenu:Get('sheriff', 'main'), "LSPD", "Intéraction"))
RMenu.Add('sheriff', 'voiture', RageUI.CreateSubMenu(RMenu:Get('sheriff', 'main'), "LSPD", "Intéraction"))
RMenu.Add('sheriff', 'chien', RageUI.CreateSubMenu(RMenu:Get('sheriff', 'main'), "LSPD", "Intéraction"))
RMenu.Add('sheriff', 'cam', RageUI.CreateSubMenu(RMenu:Get('sheriff', 'main'), "LSPD", "Intéraction"))
RMenu.Add('sheriff', 'megaphone', RageUI.CreateSubMenu(RMenu:Get('sheriff', 'main'), "LSPD", "Intéraction"))
...
Citizen.CreateThread(function()
    local sheriffmap = AddBlipForCoord(369.53, -1576.36, 29.29)
    SetBlipSprite(sheriffmap, 468)
    SetBlipColour(sheriffmap, 5)
