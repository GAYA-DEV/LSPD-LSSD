...
Citizen.CreateThread(function()
	...
	ped = CreatePed("PED_TYPE_CIVMALE", "s_m_y_cop_01", 428.61, -1012.05, 0.87, 234.95, false, true) -- voiture
...
Citizen.CreateThread(function()
	...
	ped = CreatePed("PED_TYPE_CIVMALE", "s_m_y_cop_01", 460.69, -979.65, 42.69, 176.96, false, true) -- helico
	SetBlockingOfNonTemporaryEvents(ped, true)
	FreezeEntityPosition(ped, true)
end)
...
Citizen.CreateThread(function()
	...
	ped = CreatePed("PED_TYPE_CIVMALE", "s_m_y_cop_01", 467.56, -991.14, 23.92, 177.97, false, true)
	SetBlockingOfNonTemporaryEvents(ped, true)
	FreezeEntityPosition(ped, true)
